...
UNITS="triagent.service triagent-scan.service triagent-scan.timer triagent-update.service triagent-update.timer triagent-ollama-recycle.service triagent-ollama-recycle.timer triagent-watch.service triagent-watch.timer close1-take.service close1-take.timer"
...
systemctl enable --now close1-take.timer
